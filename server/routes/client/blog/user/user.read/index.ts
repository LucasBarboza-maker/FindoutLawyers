...
import { schema, IRouteBlog_BlogUser_Read_SchemaQuerystring } from './schema';
...
export function RouteClient_NewsUser_Read({
    fastify,
    redis,
    prisma,
    socket,
    ...
    return fastify.route({
        ...
        handler: async function (request: FastifyRequest, reply: FastifyReply) {
            try {
                ...
                const { id } =
                    request.query as IRouteBlog_BlogUser_Read_SchemaQuerystring;
